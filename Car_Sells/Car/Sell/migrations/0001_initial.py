    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.IntegerField(choices=[(1, 'Small SUV'), (2, 'Medium SUV'), (3, 'Large SUV')], verbose_name='category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid', models.ForeignKey(db_column='pid', on_delete=django.db.models.deletion.CASCADE, to='Sell.product')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
